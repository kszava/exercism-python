...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category_list = [VEGAN, VEGETARIAN, PALEO, KETO, OMNIVORE]
    category_name_list = ["VEGAN", "VEGETARIAN", "PALEO", "KETO", "OMNIVORE"]

    for category, category_name in zip(category_list, category_name_list):
        jumped_out = False
...
def tag_special_ingredients(dish):
    ...
    return tuple([dish_name, special])
...
def separate_appetizers(dishes, appetizers):
    ...
    result = set_dishes.difference(set_appetizers)
    return list(result)
